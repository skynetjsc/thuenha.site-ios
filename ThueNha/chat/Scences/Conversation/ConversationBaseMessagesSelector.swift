//
//  ConversationBaseMessagesSelector.swift
//  ThueNha
//
...
public class ConversationBaseMessagesSelector: ConversationMessagesSelectorProtocol {
    
    public weak var delegate: ConversationMessagesSelectorDelegate?
